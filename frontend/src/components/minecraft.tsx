...
export function Minecraft() {
  ...
  return (
    <Card className="w-full max-w-5xl mx-auto mt-8 shadow-lg border border-gray-200 dark:border-gray-700">
      <CardHeader>
        <CardTitle className="text-xl font-mono">Minecraft Server Output</CardTitle>
      </CardHeader>
